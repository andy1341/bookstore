...
ActiveRecord::Schema.define(version: 2016_07_25_130049) do
  ...
  create_table "orders_items", id: :serial, force: :cascade do |t|
    t.integer "book_id"
    t.decimal "count"
    t.decimal "cost"
    t.integer "order_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["book_id"], name: "index_orders_items_on_book_id"
